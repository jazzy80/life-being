...
var files = [
    "/life-being/resources/IMG_3509.JPG",
    "/life-being/resources/IMG_3480.JPG",
    "/life-being/resources/IMG_3569.JPG",
    "/life-being/resources/IMG_3631.JPG",
    "/life-being/resources/IMG_3583.JPG"
];
if (header && prevButton && nextButton)
    (0, slideshow_1.setUpSlideShow)(header, prevButton, nextButton, files);
...
function resetSlideShow(header, files) {
    header.style.backgroundImage = "url(".concat(files[0]);
}
function setImage(header, file) {
    header.style.backgroundImage = "url(".concat(file, ")");
}
